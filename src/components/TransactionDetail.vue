<template>
  ...
  <div class="m-2">
    ...
    <div v-if="state.requestStatus === 'Success'" class="font-semibold text-green-600">Success!</div>
    <div class="my-2 text-red-500 text-xl font-semibold flex justify-center">Danger Zone</div>
    <div v-if="!isNaN(parseInt(transactionId))" class="flex justify-center">
      <button class="bg-red-600 text-white font-semibold p-2 rounded-lg">Delete</button>
    </div>
  </div>
  <!-- <div>
    {{ router }}
